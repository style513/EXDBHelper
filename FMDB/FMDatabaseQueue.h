...
+ (FMDatabaseQueue *)databaseQueueWithPath:(NSString*)aPath;
...
/** Create queue using path and specified flags.
 ...
 @return The `FMDatabaseQueue` object. `nil` on error.
 */
+ (FMDatabaseQueue *)databaseQueueWithPath:(NSString*)aPath flags:(int)openFlags;
...
- (FMDatabaseQueue *)initWithPath:(NSString*)aPath;
...
- (FMDatabaseQueue *)initWithPath:(NSString*)aPath flags:(int)openFlags;
